...
* The original package name 'org.studi.restaurant-reservation' is invalid and this project uses 'org.studi.restaurantreservation' instead.
...
```
$ docker run --rm -p 8080:8080 restaurant-reservation:0.0.1-SNAPSHOT
```
